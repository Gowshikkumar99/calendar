  ...
  return (
    <div
      className={`nested-modal${
        position === "mobile" ? " nested-modal--mobile" : ""
      }`}
    ...
    >
      <div className="nested-modal-header">
        <span>Meeting</span>
        <button className="nested-modal-close-btn" onClick={onClose}>
          x
        </button>
      </div>
          ...
          <div className="nested-event-card" key={i}>
            <div className="event-wrapper">
              ...
              <div className="event-actions">
                ...
                <button
                  className="delete-btn nested-btn"
                  onClick={() => onDelete(ev)}
                >
            ...
            <div className="event-meta">
              ...
              <div className="event-meta-row">
                ...
                <div className="event-time">
                  Time: {moment(ev.start).format("hh:mm A")} -{" "}
